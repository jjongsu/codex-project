  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
      <div className="rounded-[32px] border border-black/10 bg-white/88 p-8 shadow-[0_20px_60px_rgba(15,23,42,0.06)]">
        ...
        <h1 className="mt-3 text-4xl font-semibold text-black">Privacy scaffold</h1>
        <p className="mt-4 text-base leading-7 text-black/68">
          Document cookie usage, analytics, ad disclosures, and score submission
          data handling here once the data pipeline is connected.
        </p>
      </div>
    </div>
  );
